 ...
 */
export const ADD_SECTION_PROPERTY = '@@sheets/ADD_SECTION_PROPERTY'
...
export const EDIT_SELECTED_SECTION = '@@sheets/EDIT_SELECTED_SECTION'
export const SET_CURRENT_SECTION_PROPERTY_INDEX = '@@sheets/SET_CURRENT_SECTION_PROPERTY_INDEX'
