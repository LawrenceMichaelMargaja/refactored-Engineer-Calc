...
const MetricMaterialPropertiesRowsDesign = () => {
                        ...
                        if (size(insertedSteelTypesMetric) === 0) {
                            ...
                            if (proceed) {
                                ...
                                dispatch(editSelectedEnglishMaterialProperty(
                                    selectedName,
                                    materialEnglishCounterValueEMPA(),
                                    hashMetric[selectedName].steel_type_metric_fy,
                                    hashMetric[selectedName].steel_type_metric_fu,
                                    false,
                                    selectedSheet,
                ...
                if (hashCustom[insertedSteelTypesMetric[materialPropertyIndex].name].custom === false) {
                    ...
                    for (let name in steelTypesEnglish) {
                        if (customSelectedSteelType === steelTypesEnglish[name].steel_type_english_name) {
                            // alert("hey hey")
                            return hashEnglish[[insertedSteelTypesEnglish[materialPropertyIndex].name]].EMPA
                        } else {
    ...
    const renderRows = () => {
        for (let materialPropertiesIndex in materialPropertiesMetric) {
            ...
            const materialId = materialPropertiesMetric[materialPropertiesIndex].id
...
export default MetricMaterialPropertiesRowsDesign
